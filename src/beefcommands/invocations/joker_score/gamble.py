...
from beefcommands.invocations.joker_score.change_joker_score import set_highest_score, set_lowest_score, add_score_change_record
...
async def gamble_points(interaction: discord.Interaction):
    ...
    await add_score_change_record(user, user, value-1, "gamble")
